...
return [
    ...
    'cleanup' => [
        ...
        'default_strategy' => [
             ...
             *
             * Set to 0 (along with the weekly/monthly/yearly tiers below) so nothing
             * survives past the 3-day cutoff above — only the single newest backup
             * is ever kept regardless of age.
             */
