...
class PermissionCatalog
{
    ...
    public static function all(): array
    {
        return [
            ...
            'expense_type' => [
                'expense_type.index' => __('View'),
                'expense_type.create' => __('Create'),
                'expense_type.update' => __('Update'),
                'expense_type.delete' => __('Delete'),
            ],
            'expense' => [
                'expense.index' => __('View'),
                'expense.create' => __('Create'),
                'expense.update' => __('Update'),
                'expense.delete' => __('Delete'),
            ],
            'room_booking' => [
                'room_booking.index' => __('View'),
                'room_booking.create' => __('Create'),
                'room_booking.update' => __('Update'),
                'room_booking.delete' => __('Delete'),
                'room_booking.collect' => __('Collect Payments'),
            ],
            'exemption_type' => [
    ...
    public static function moduleLabels(): array
    {
        return [
            ...
            'expense_type' => __('Expense Types'),
            'expense' => __('Expenses'),
            'room_booking' => __('Room Bookings'),
